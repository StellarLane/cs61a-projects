...
class ThrowerAnt(Ant):
    ...
    def nearest_bee(self, beehive):
        ...
        aim_dist=0
        while aim_place is not beehive and aim_dist<self.min_range:
            aim_place=aim_place.entrance
            aim_dist+=1
        while aim_place is not beehive and aim_dist>=self.min_range and aim_dist<=self.max_range:
            if len(aim_place.bees)>0:
                return rANTdom_else_none(aim_place.bees)
            aim_place=aim_place.entrance
            aim_dist+=1
        return None        
        # END Problem 3 and 4
...
# END Problem EC
    ...
    def action(self, gamestate):
        ...
        if self.is_imposter:
            ...
            while curr_loc:
                if curr_loc.ant and not curr_loc.ant.buffed:
                    curr_loc.ant.damage*=2
                    curr_loc.ant.buffed=True
